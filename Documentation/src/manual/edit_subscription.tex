...
\img[scale=.4]{img/enter_email_prompt.png}{E-Mail-Eingabeaufforderung}{enter-email-prompt}
...
\img[scale=.2]{img/edit_subscription.png}{Übersicht Ihres Abonnements}{edit-subscription}
