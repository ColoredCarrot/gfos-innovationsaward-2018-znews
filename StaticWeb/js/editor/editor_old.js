/*
 * This file contains many utility methods
 * and functions to support a markdown editor.
 */
window.mkeditor = (function()
{
    ...
    let mkeditor = {
        ...
        {
            mkeditor.swal = options.swal;
            mkeditor.$progressBar = options.$progressBar;
        },
